...
public class SearchCoursePage extends PageObject {
    ...
    public static final Target IMPUT_COURSE = Target.the("Buscar el curso")
            .located(By.id("coursesearchbox"));
    public static final Target BUTTON_GO = Target.the("Da click para buscar el curso")
            .located(By.id("//button[@class='btn btn-secondary']"));
    public static final Target SELECT_COURSE = Target.the("Da click para escoger el curso")
            .located(By.xpath("//h4[contains(text()),'Recursos Automatizacion Bancolombia']"));
    public static final Target NAME_COURSE = Target.the("Extae el nombre del curso")
